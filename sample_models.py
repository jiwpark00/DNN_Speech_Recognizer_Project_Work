...
def cnn_output_length_pooling(input_length, filter_size, border_mode, stride,
                       dilation=1, pooling=2):
    """ Compute the length of the output sequence after 1D convolution along
        time. Note that this function is in line with the function used in
        Convolution1D class from Keras.
    Params:
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    # TODO: Add recurrent layers, each with batch normalization
        simp_rnn = GRU(units, activation='relu',return_sequences=True, implementation=2)(layer_input)
        layer_input = BatchNormalization()(simp_rnn)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
    time_dense = TimeDistributed(Dense(output_dim))(layer_input)
    # Add softmax activation layer
    y_pred = Activation('softmax', name='softmax')(time_dense)
    # Specify the model
    model = Model(inputs=input_data, outputs=y_pred)
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(layer=rnn)(input_data)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def cnn_lstm_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bn_cnn = BatchNormalization(name='bn_conv_1d')(conv_1d)
    # Add a recurrent layer
    lstm_rnn = LSTM(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn')(bn_cnn)
    # TODO: Add batch normalization
